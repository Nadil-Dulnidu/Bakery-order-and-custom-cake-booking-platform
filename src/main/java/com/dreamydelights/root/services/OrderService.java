...
public class OrderService {
    ...
    //create new order
    public void createOrder(String userId, double totalPrice, ArrayList<Cart> cartItems,String customerEmail, String customerFirstname, String customerLastName, String customerPhone, String customerAddress, String customerCity, String customerPostalCode) {
    ...
    //get order list by userid and status
    public ArrayList<Order> getAllOrders(String userId, String status) {

package com.customcakemanagement.root.service;
...
public class CustomCakeService {
    ...
    public static final String filePath = "C:\\Users\\Nusri\\Desktop\\New folder (2)\\custom-cake-management\\data\\custom-order.txt";
    ...
    public void deleteCakeOrder(String cakeId){
        ...
        try(BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(filePath,false))) {
            for (CustomCake cake : customCakes){
                if(!cake.getCakeId().equals(cakeId)){
                    bufferedWriter.write(cake.getCakeId()+"//" +cake.getFirstName()+"//" +cake.getLastName()+"//" +cake.getEmail()+"//" +cake.getPhone()+"//" +cake.getDate()+"//" +cake.getCakeDetails()+"//" +cake.getBudgetDetails()+"//" +cake.getDeliveryLocation()+"//" +cake.getEnquiryStatus()+"//" +cake.getImagePath());

package com.productmanagemnt.root.service;
...
public class ProductService {
    public static final String filePath = "C:\\Users\\Admin\\Desktop\\product managemnt\\product-managemnt\\data\\product.txt";
    ...
    //display products
    public List<Product> displayProductByCategory() {
        List<Product> products = new ArrayList<>();
        try(FileReader fileReader = new FileReader(filePath)){
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String line;
